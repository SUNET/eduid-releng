...
class State(UserDict):
    ...
    def __init__(self, urlstate_data=None, encryption_key=None):
        ...
        if urlstate_data:
            try:
                ...
                urlstate_data_decompressed = zlib.decompress(urlstate_data_b64decoded)
                urlstate_data_decrypted = _AESCipher(encryption_key).decrypt(
                    urlstate_data_decompressed
                )
                urlstate_data_decrypted_decompressed = zlib.decompress(urlstate_data_decrypted)
    ...
    def urlstate(self, encryption_key):
        ...
        # lzma = LZMACompressor()
        urlstate_data = zlib.compress(urlstate_data)
